...
class Directory {
    ...
    /* Compares the passed fileIndex to the current DirectoryEntry objects, and returns just the FileInfo objects we need to download/delete, if any. Except for the following, the directory is not changed as a result of this call:
