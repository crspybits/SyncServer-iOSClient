...
public class SyncServer {
    ...
    // When uploading a file for the 2nd or more time ("multi-version upload") the 2nd and following versions have to have the same mimeType as the first version of the file.
